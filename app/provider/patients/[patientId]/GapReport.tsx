            ...
            <div className="space-y-6">
              {markdown && (
                <div className="max-w-none">
                  <h2 className="mt-0 text-lg font-semibold">Gap Report — {json?.gapReport?.patientName || ''}</h2>
                  <p className="text-sm text-muted-foreground mb-3">Provider-facing script generated from the intake responses:</p>
                  <div className="rounded border bg-white p-3 text-sm whitespace-pre-wrap leading-6">
                    {markdown}
                  </div>
                  <div className="pt-3">
